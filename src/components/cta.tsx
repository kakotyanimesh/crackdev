...
export default function Cta(){
    return (
        <div className="flex flex-col justify-center space-y-3 items-center bg-gradient-to-r from-purple-500 to-purple-700 rounded-2xl md:py-20 p-10 md:px-20">
            ...
            <button className="bg-white cursor-pointer font-medium disabled:pointer-events-none transition-colors disabled:backdrop-blur-3xl inline-flex justify-center text-center items-center whitespace-nowrap px-4 py-2 rounded-md">Start Free Trial</button>
            </div>
        </div>
    )
}